    ...
    <div className="min-h-screen flex flex-col transition-all">
      <div className="bg-sky-400 h-20 shadow-md sticky top-0 z-50">
        <ul className="flex items-center justify-between"> 
          <h1 className="text-white font-bold mt-2">HOME</h1>
          <li className="mt-2">
            <a href="#Beranda" className="text-white font-medium no-underline text-2xl">Login</a>
          </li>
          <li className="ml-25 mt-2">
            <a href="#Jurusan" className="text-white font-medium no-underline text-2xl">Jurusan</a>
          </li>
          <li className="mx-30 mt-2">
            <a href="#about" className="font-medium text-white no-underline text-2xl">Tentang Kami</a>
          </li>
        </ul>
      </div>
  ...
  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-5 rounded focus:outline-none focus:shadow-outline my-2">
    <a href="/Login" className="text-white focus:outline-none no-underline whitespace-nowrap text-2xl">Daftar Sekarang</a>
          ...
          <div id='Jurusan' className="mt-10 h-30 grid grid-cols-5 gap-94">
            <h1 className="mx-153 text-3xl font-bold text-shadow-lg">Jurusan</h1>
            ...
            <div id='about' className="about py-auto mx-143 -mt-100">
